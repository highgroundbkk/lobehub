...
async function selectVersionTypeInteractive(): Promise<VersionType> {
  const choices: { name: string; value: VersionType }[] = [
    { value: 'patch', name: '🔧 patch - Bug fixes (e.g., 1.0.0 -> 1.0.1)' },
    { value: 'minor', name: '✨ minor - New features (e.g., 1.0.0 -> 1.1.0)' },
    { value: 'major', name: '🚀 major - Breaking changes (e.g., 1.0.0 -> 2.0.0)' },
  ];
